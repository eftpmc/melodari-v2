            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="flex items-center p-4 bg-base-100 rounded-lg shadow">
                    ...
                    <button
                        ...
                        className={`btn btn-sm ${isGoogleAuth ? "btn-success" : savedGooglePlaylists ? "btn-warning" : "btn-error"
                            }`}
                ...
                <div className="flex items-center p-4 bg-base-100 rounded-lg shadow">
                    ...
                    <button
                        ...
                        className={`btn btn-sm ${isSpotifyAuth ? "btn-success" : savedSpotifyPlaylists ? "btn-base-content" : "btn-error"
                            }`}
